...
class TodoService(
    ...
    suspend fun getAll(call: ApplicationCall) {
        ...
        val isDone = if (isDoneParam.isNullOrBlank()) null else isDoneParam.toBooleanStrictOrNull()
    ...
    suspend fun getById(call: ApplicationCall) {
        ...
        val response = DataResponse("success", "Berhasil mengambil data todo", mapOf(Pair("todo", todo)))
        call.respond(response)
    }
    ...
    suspend fun putCover(call: ApplicationCall) {
        ...
        // Mencegah nilai tertimpa ke default
