...
class UserRepository : IUserRepository {
    ...
    override suspend fun create(user: User): String = suspendTransaction {
        val userDAO = UserDAO.new {
            ...
            about = user.about // Ditambahkan untuk proteksi jika ada insert about saat register
    ...
    override suspend fun update(id: String, newUser: User): Boolean = suspendTransaction {
        ...
        if (userDAO != null) {
            ...
            userDAO.about = newUser.about // [PERBAIKAN KRITIS]: Memasukkan about ke database
